...
$query_Food1 = "SELECT * FROM food WHERE typeid = 2222";
$Food1 = mysql_query($query_Food1, $Myconnect) or die(mysql_error());
$row_Food1 = mysql_fetch_assoc($Food1);
$totalRows_Food1 = mysql_num_rows($Food1);mysql_select_db($database_Myconnect, $Myconnect);
...
<body>
        ...
        <div class="container">
            <div class="starter-template">
                <h1 class="text-center"><u><i><b>เมนูข้าวผัด</b></i></u></h1>
